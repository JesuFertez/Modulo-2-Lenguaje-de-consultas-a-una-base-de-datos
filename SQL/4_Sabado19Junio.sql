...
select * from alumno;
select nombre,curso,promedio from alumno;
select * from libro;
select nombre, autor, ejemplares from libro;
select * from Empleado1;
select nombre, cargo, sueldo from Empleado1;
select * from alumno where id_Alumno=2;
select * from alumno where edad=12;
select * from libro where ejemplares>= 10;
select * from libro where edicion='Primera Edición';
select *from Empleado1 where departamento= 'RecursosHumanos';
select * from Empleado1 where fechaIngreso>= '2003-01-01';
select *from Empleado1 where cargo= 'teleoperadora' and edad>=20;
select *from Empleado1 where edad>27 and fechaIngreso>='2018-01-01'; 
select *from libro where ejemplares >10 and añoPublicacion >'2020-02-10';
select *from libro where editorial='Casa Negra' and ejemplares >5;
select * from alumno where promedio>= 5.50 and edad> 7;
select *from alumno where edad>5 and nombre='Catalina';
select *from Empleado1 where cargo='secretaria' or cargo='Servicio Cliente';
select * from Alumno where promedio>5.50 or promedio>=6.60;
select *from libro where edicion= 'Primera Edición' or añoPublicacion<2010-01-01;
select * from Empleado1;
select * from Empleado1 where id_Empleado in (1,21,33);
select * from Empleado1 where ApellidoP in ('Castillo', 'Pérez');
select * from Alumno where edad in(7,11,12);
select *from libro where editorial in('Casa Negra', 'chamullo', 'Orda Negra');
